...
#define DELAY_UPDATE                  delay(300)   // Tiempo que espera para actualizar la pantalla
#define DELAY_BUSY                    delay(1)    // Tiempo que espera miestra esta ocupado el display
