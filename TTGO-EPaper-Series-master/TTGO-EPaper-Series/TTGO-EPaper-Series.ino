...
{
    strlcpy(info.company, "AAAAAAAAAAAAAAA", sizeof(info.company));
    strlcpy(info.name, "BBBBBBBB", sizeof(info.name));
    strlcpy(info.address, "CCCCCCCCCCCCCCCCCC", sizeof(info.address));
    strlcpy(info.email, "DDDDDDDDDDDDDD", sizeof(info.email));
    strlcpy(info.link, "eeeeeeeeeeeeEEEEEEEEEEEEE", sizeof(info.link));
    strlcpy(info.tel, "15-32315076", sizeof(info.tel));
    saveBadgeInfo(&info);
}
